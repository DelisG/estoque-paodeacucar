...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-info">
        <div class="container-fluid">
            <a class="navbar-brand" href="index.php">Pão de Açucar</a>
    ...
    <div class="container">
        ...
        <h1 class="mt-4">Editar Produto: <?php echo $nome; ?></h1>
        ...
        <form action="editar.php" method="post">
            ...
            <div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="exampleFormControlInput1" name="preco" value="<?php echo $preco; ?>">
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Data</label>
                    <input type="date" class="form-control" id="exampleFormControlInput1" name="data" value="<?php echo $data; ?>">
                </div>
                <div class="mb-3">
